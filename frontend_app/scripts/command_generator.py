...
def generate_command_file(data_holder : DataHolder)  : 
  ...
  class_template = """
  import 'package:frontend_app/application/ServiceStore/service.dart';
  import 'package:frontend_app/infrastructure/SERVICE_NAME/api.dart';
  import 'package:frontend_app/infrastructure/services.dart';
